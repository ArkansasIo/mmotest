...
ob_start();
?>
<div class="page-title"><h1>Intelligence Operations</h1><span class="muted">Turn 84</span></div>
<div class="grid">
  <section class="panel"><h2>Intelligence Operations</h2><div class="panel-body">
